insert or replace into LocalizedText (Language, Tag, Text) values
	("zh_Hans_CN", "LOC_TRAIT_CIVILIZATION_GEDEMO_ZIMBABWE_CIV_TRAIT_NAME", 				"黄金与象牙国度"),
	...
	("zh_Hans_CN", "LOC_IMPROVEMENT_GEDEMO_DZIMBABWE_DESCRIPTION", 									"+1 [ICON_PRODUCTION] 生产力、[ICON_Culture] 文化值和 [ICON_Housing] 住房。你每拥有一种运载资源，+3 [ICON_GOLD] 金币；每拥有一种建造资源，+1 [ICON_PRODUCTION] 生产力；每拥有一种艺术资源，+1 [ICON_Culture] 文化值；每拥有一种庆典资源，+1 [ICON_FAITH] 信仰值。若相邻淡水，则额外+3 [ICON_Housing] 住房。[NEWLINE]每个城市仅限建造一座。"),

	("zh_Hans_CN", "LOC_UNIT_GEDEMO_ROZWI_NAME", 																		"猎象人"),
	("zh_Hans_CN", "LOC_UNIT_GEDEMO_ROZWI_DESCRIPTION", 														"远古时代的津巴布韦特色单位，取代枪兵。开局解锁，战斗力较低但造价更低。攻击后可移动，与 [ICON_Barbarian] 蛮族战斗时+7 [ICON_STRENGTH] 战斗力。无视丘陵、森林和雨林对 [ICON_MOVEMENT] 移动力的减益。视野能穿过树林和雨林。造访部落村庄或摧毁 [ICON_Barbarian] 蛮族哨站后，有概率带回牧场或营地资源。"),
	("zh_Hans_CN", "LOC_ABILITY_HD_ROZWI_DESCRIPTION", 															"攻击后可移动，与 [ICON_Barbarian] 蛮族战斗时+7 [ICON_STRENGTH] 战斗力。无视丘陵、森林和雨林对 [ICON_MOVEMENT] 移动力的减益。视野能穿过树林和雨林。"),
	("zh_Hans_CN", "LOC_ABILITY_HD_ROZWI_PROPERTY_DESCRIPTION", 										"造访部落村庄或摧毁 [ICON_Barbarian] 蛮族哨站后，有概率带回牧场或营地资源。"),
